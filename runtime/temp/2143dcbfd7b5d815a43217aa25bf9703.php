<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"E:\WWWROOT\outengcms\WwwRoot/application/otadmins\view\login.html";i:1494227367;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        ...
        <div class="col-sm-5" style="color:#fff">
            <form id="doLogin" name="doLogin" method="post" action="<?php echo url('doLogin'); ?>">
                ...
                <input type="text" class="form-control uname" placeholder="用户名" id="username" name="username" value="admin" />
                <input type="password" class="form-control pword m-b" placeholder="密码" id="password" name="password" value="tianjianlong0923" />
